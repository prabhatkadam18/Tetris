...
public class Tetris{
  ...
  public static void main(String args[]){
    ...
    shapes[0].version[1][2] = new Point(0, 2);
    shapes[0].version[1][3] = new Point(0, 3);
    ...
    Point currentLocation = new Point(board.row - 3, rand.nextInt(board.col - 5) + 2);
